...
public class OddEvenTrendPresenter extends BaseMvpPresenter<BigSmallTrendContract.IView> implements BigSmallTrendContract.P{

    ManageRepository repository;
    public OddEvenTrendPresenter(BigSmallTrendContract.IView view) {
        super(view);
