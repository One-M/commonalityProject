...
public class MantissaTrendPresenter extends BaseMvpPresenter<BigSmallTrendContract.IView> implements BigSmallTrendContract.P{

    ManageRepository repository;
    public MantissaTrendPresenter(BigSmallTrendContract.IView view) {
        super(view);
