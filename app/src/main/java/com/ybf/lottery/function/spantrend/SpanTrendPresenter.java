...
public class SpanTrendPresenter extends BaseMvpPresenter<BigSmallTrendContract.IView> implements BigSmallTrendContract.P{

    ManageRepository repository;
    public SpanTrendPresenter(BigSmallTrendContract.IView view) {
        super(view);
