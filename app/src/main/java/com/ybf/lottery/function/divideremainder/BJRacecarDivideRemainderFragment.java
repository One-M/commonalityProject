 ...
 * Use:除三余(012)走势fragment
 */

public class BJRacecarDivideRemainderFragment extends BaseMvpFragment<BigSmallTrendPresenter> implements BigSmallTrendContract.IView, View.OnClickListener, ScrollChangeCallback {
    ...
    public static BJRacecarDivideRemainderFragment newInstance(int trendType) {
        Bundle args = new Bundle();
        args.putInt(TREND_TYPE , trendType);
        BJRacecarDivideRemainderFragment fragment = new BJRacecarDivideRemainderFragment();
