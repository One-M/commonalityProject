...
public class BJRacecarPrimeNumTrendFragment extends BaseMvpFragment<BigSmallTrendPresenter> implements BigSmallTrendContract.IView, View.OnClickListener, ScrollChangeCallback {
    ...
    public static BJRacecarPrimeNumTrendFragment newInstance(int trendType) {
        Bundle args = new Bundle();
        args.putInt(TREND_TYPE , trendType);
        BJRacecarPrimeNumTrendFragment fragment = new BJRacecarPrimeNumTrendFragment();
