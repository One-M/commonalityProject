...
import com.ybf.lottery.function.firstsecondtrend.FirstSecondContract;
import com.ybf.lottery.function.firstsecondtrend.FirstSecondPresenter;
...
public class BJRacecarBigSmallTrendFragment extends BaseMvpFragment<BigSmallTrendPresenter> implements BigSmallTrendContract.IView, View.OnClickListener, ScrollChangeCallback {
    ...
    public static BJRacecarBigSmallTrendFragment newInstance(int trendType) {
        Bundle args = new Bundle();
        args.putInt(TREND_TYPE , trendType);
        BJRacecarBigSmallTrendFragment fragment = new BJRacecarBigSmallTrendFragment();
