...
public class WuXingTrendPresenter extends BaseMvpPresenter<BigSmallTrendContract.IView> implements BigSmallTrendContract.P{

    ManageRepository repository;
    public WuXingTrendPresenter(BigSmallTrendContract.IView view) {
        super(view);
