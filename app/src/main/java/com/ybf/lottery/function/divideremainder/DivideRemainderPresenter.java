 ...
 * Use:除三余(012)走势的presenter
 */

public class DivideRemainderPresenter extends BaseMvpPresenter<BigSmallTrendContract.IView> implements BigSmallTrendContract.P{

    ManageRepository repository;
    public DivideRemainderPresenter(BigSmallTrendContract.IView view) {
        super(view);
