...
public class BJRacecarOddEvenTrendFragment extends BaseMvpFragment<BigSmallTrendPresenter> implements BigSmallTrendContract.IView, View.OnClickListener, ScrollChangeCallback {
    ...
    public static BJRacecarOddEvenTrendFragment newInstance(int trendType) {
        Bundle args = new Bundle();
        args.putInt(TREND_TYPE , trendType);
        BJRacecarOddEvenTrendFragment fragment = new BJRacecarOddEvenTrendFragment();
