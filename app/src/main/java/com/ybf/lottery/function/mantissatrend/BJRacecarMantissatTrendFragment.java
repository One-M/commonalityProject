...
public class BJRacecarMantissatTrendFragment extends BaseMvpFragment<BigSmallTrendPresenter> implements BigSmallTrendContract.IView, View.OnClickListener, ScrollChangeCallback {
    ...
    public static BJRacecarMantissatTrendFragment newInstance(int trendType) {
        Bundle args = new Bundle();
        args.putInt(TREND_TYPE , trendType);
        BJRacecarMantissatTrendFragment fragment = new BJRacecarMantissatTrendFragment();
