 ...
 * Use:冠亚和值首页入口Activity
 */

public class WinnerRunnerSumValueActivity extends BaseActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        BJRacecarWinnerRunnerSumValueFragment sumValueFragment = BJRacecarWinnerRunnerSumValueFragment.newInstance(1); // 传参标记入口type 导航栏入口传0 其它传l
        fragmentTransaction.add(R.id.data_fragment, sumValueFragment);
