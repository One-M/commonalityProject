...
public class BasicTrendAdapter extends BaseQuickAdapter<BasicTrendStatisticBean , BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder holder, BasicTrendStatisticBean data) {
        holder.setText(R.id.basic_trend_cxcs , data.getData1()+"");
        holder.setText(R.id.basic_trend_zdlc , data.getData2()+"");
        holder.setText(R.id.basic_trend_zdyl , data.getData3()+"");
        holder.setText(R.id.basic_trend_pjyl , data.getData4()+"");
        holder.setText(R.id.basic_trend_dqyl , data.getData5()+"");
    }
}
